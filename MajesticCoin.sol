...
contract MajesticCoin is StandardToken { 
    ...
    function MajesticCoin() {
        ...
        name = "MajesticCoin";                                   // Set the name for display purposes
        decimals = 18;                                               // Amount of decimals for display purposes
        symbol = "MAJ";                                             // Set the symbol for display purposes 
